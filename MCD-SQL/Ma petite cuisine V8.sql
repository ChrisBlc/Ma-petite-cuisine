...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 14 juin 2022 à 09:19
...
(166, 'Cisailler la viande en tranches très fines, et faire mariner au frigo avec le curry, ail, glutamate et les sauces, au moins 30 mn.', 1),
(167, 'Pendant ce temps préparer la sauce, si vous cuisinez souvent asiatique, doubler les proportions et conservez-là dans un bocal. Vous pouvez ajouter une pointe de piment (sauce chili) pour la parfumer. Faire bouillir tous les ingrédients et réserver.', 1),
(168, 'Pendant ce temps préparer la sauce, si vous cuisinez souvent asiatique, doubler les proportions et conservez-là dans un bocal. Vous pouvez ajouter une pointe de piment (sauce chili) pour la parfumer. Faire bouillir tous les ingrédients et réserver.', 1),
(169, 'Faire revenir la viande dans un peu d\'huile, à feu très fort et très brièvement : la viande doit être saisie simplement, pour la garder tendre.', 1),
(170, 'Servir dans des grand bols de préférence : commencer par la batavia, le soja, puis 3 ou 4 poignées de vermicelles par personnes, 2 nems coupés petits morceaux par personne, la viande. Décorer avec la coriandre hachée, la menthe et quelques cacahuètes concassées (facultatif). Arroser de sauce et c\'est prêt !', 1);
...
(5, 'Amande sèche', 'Amandes.jpg', 5),
(6, 'Ananas ', '', 1),
(7, 'Arachide', 'Arachide.jpeg', 5),
(8, 'Artichaut ', '', 1),
(9, 'Asperge ', 'Asperges.jpg', 5),
(10, 'Aubergine ', '', 1),
(11, 'Banane ', '', 1),
...
(58, 'Fécule PdT', 'Fecule_pomme_de_terre.jpg', 5),
(59, 'Fèves ', '', 5),
(60, 'Figue ', '', 5),
...
(93, 'Noix ', '', 5),
(94, 'Noix de coco', '', 1),
(95, 'Œuf (blanc d\'œuf)', 'Oeufs.jpg', 1),
(96, 'Œuf (jaune d\'œuf)', 'Oeufs.jpg', 1),
(97, 'Œuf entier', 'Oeufs.jpg', 1),
...
(155, 'Yaourt ', 'yaourt.jpg', 1),
(156, 'Mayonnaise', 'Mayonnaise.jpg', 4),
(157, 'Romarin', 'Romarin.jpg', 1),
(158, 'Semoule dessert', 'semoule.jpg', 5),
(159, 'Fleur d\'oranger', 'fleur_d\'oranger.jpg', 2);
...
(1, 'Bo-Bun', '00:35:00', '00:15:00', 1, '2022-05-04', 1, 1, 6),
...
(9, 'Pâtes au pesto de coriandre', '00:05:00', '00:10:00', 1, '2021-05-05', 3, 1, 1),
...
INSERT INTO `recettes_categories` (`id_relation`, `id_recette`, `id_categorie`) VALUES
(1, 6, 1),
(2, 7, 1),
(5, 2, 2),
(6, 6, 2),
...
INSERT INTO `recettes_ingredients` (`id_relation`, `id_recette`, `id_ingredient`, `Dosage`) VALUES
(1, 1, 3, '0,25'),
(2, 3, 3, '0,5'),
(3, 5, 3, '0,833333333'),
(4, 6, 3, '0,5'),
...
(8, 2, 9, '1000'),
(11, 1, 12, '0,25'),
(12, 13, 13, '0.33333333333333'),
(13, 3, 14, '2,5'),
(14, 8, 14, '18,33333333'),
(15, 12, 14, '16,66666667'),
(16, 10, 29, '0,5'),
(17, 8, 37, '48,33333333'),
(18, 4, 40, '0,25'),
(19, 10, 40, '2,5'),
...
(49, 6, 99, '1'),
(50, 10, 99, '2'),
(51, 5, 100, '0,266666667'),
(52, 6, 102, '0,833333333'),
(53, 9, 103, '40'),
(54, 12, 105, '0,26666666'),
(55, 9, 106, '100'),
(56, 2, 108, '0,25'),
(57, 10, 109, '62,5'),
(58, 9, 110, '15'),
(59, 6, 111, '0,833333333'),
(60, 9, 112, '12,5'),
(61, 6, 115, '83,33333333'),
(62, 5, 117, '500'),
(63, 1, 118, '0,25'),
(64, 3, 118, '0,25'),
(65, 4, 118, '0,25'),
(66, 5, 118, '0,266666667'),
(67, 10, 118, '1,25'),
(68, 12, 120, '0,833333333'),
(69, 3, 121, '200'),
(70, 4, 121, '250'),
(71, 5, 121, '100'),
(72, 4, 127, '0,25'),
(73, 10, 129, '30'),
(74, 5, 131, '0,833333333'),
(75, 1, 135, '0,75'),
(76, 10, 136, '0,5'),
(77, 1, 139, '0,25'),
(78, 3, 139, '0,5'),
(79, 4, 139, '0,25'),
(80, 5, 139, '0,266666667'),
(81, 7, 139, '0,225'),
(82, 9, 139, '3,75'),
(83, 10, 139, '1,25'),
(84, 12, 139, '0,833333333'),
(85, 7, 143, '1,875'),
(86, 8, 143, '20'),
(87, 12, 143, '7,5'),
(88, 5, 145, '0,5'),
...
INSERT INTO `recettes_regimes` (`id_relation`, `id_recette`, `id_regime`) VALUES
(1, 2, 1),
(2, 3, 1),
(3, 4, 1),
(4, 6, 1),
...
INSERT INTO `recettes_saisons` (`id_relation`, `id_recette`, `id_saison`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 3),
(4, 1, 4),
...
(7, 'Jean', 'Test', 'jeanTest@mail.com', '12', 'JeanTest', 0);
...
ALTER TABLE `etapes`
  ...
  ADD KEY `Recettes_etapes` (`id_recette`);
...
--
ALTER TABLE `etapes`
  MODIFY `id_etape` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=171;

--
-- AUTO_INCREMENT pour la table `ingredients`
--
ALTER TABLE `ingredients`
  MODIFY `id_ingredient` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=160;
...
--
-- AUTO_INCREMENT pour la table `recettes_categories`
--
ALTER TABLE `recettes_categories`
  MODIFY `id_relation` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT pour la table `recettes_ingredients`
--
ALTER TABLE `recettes_ingredients`
  MODIFY `id_relation` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;

--
-- AUTO_INCREMENT pour la table `recettes_regimes`
--
ALTER TABLE `recettes_regimes`
  MODIFY `id_relation` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;

--
-- AUTO_INCREMENT pour la table `recettes_saisons`
--
ALTER TABLE `recettes_saisons`
...
--
ALTER TABLE `avis`
  ADD CONSTRAINT `Avis_Recettes_FK` FOREIGN KEY (`id_recette`) REFERENCES `recettes` (`id_recette`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Avis_Utilisateurs0_FK` FOREIGN KEY (`id_utilisateur`) REFERENCES `utilisateurs` (`id_utilisateur`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Contraintes pour la table `etapes`
--
ALTER TABLE `etapes`
  ADD CONSTRAINT `Recettes_etapes` FOREIGN KEY (`id_recette`) REFERENCES `recettes` (`id_recette`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `photos`
  ADD CONSTRAINT `Photos_Recettes_FK` FOREIGN KEY (`id_recette`) REFERENCES `recettes` (`id_recette`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `recettes`
  ...
  ADD CONSTRAINT `Recettes_Utilisateurs1_FK` FOREIGN KEY (`id_utilisateur`) REFERENCES `utilisateurs` (`id_utilisateur`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `recettes_categories`
  ...
  ADD CONSTRAINT `recettes_categories_Recettes0_FK` FOREIGN KEY (`id_recette`) REFERENCES `recettes` (`id_recette`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `recettes_ingredients`
--
ALTER TABLE `recettes_ingredients`
  ADD CONSTRAINT `recettes_ingredients_Ingredients_FK` FOREIGN KEY (`id_ingredient`) REFERENCES `ingredients` (`id_ingredient`),
  ADD CONSTRAINT `recettes_ingredients_Recettes0_FK` FOREIGN KEY (`id_recette`) REFERENCES `recettes` (`id_recette`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `recettes_regimes`
--
ALTER TABLE `recettes_regimes`
  ADD CONSTRAINT `recettes_regimes_Recettes0_FK` FOREIGN KEY (`id_recette`) REFERENCES `recettes` (`id_recette`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `recettes_saisons`
  ADD CONSTRAINT `recettes_saisons_Recettes_FK` FOREIGN KEY (`id_recette`) REFERENCES `recettes` (`id_recette`) ON DELETE CASCADE ON UPDATE CASCADE,
